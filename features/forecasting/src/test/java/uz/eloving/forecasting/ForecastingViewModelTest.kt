package uz.eloving.forecasting

import uz.eloving.forecasting.usecase.ForecastingUseCase
import uz.eloving.forecasting.viewmodel.ForecastingViewModel
...
class ForecastingViewModelTest {
    ...
    @get:Rule
    val rule = uz.eloving.forecasting.InstantTaskExecutorRule()
